...
function ContactUsComponent() {
    return (
        <div className="container my-24 mx-auto md:px-6 pt-[120px] sm:pt-[120px] md:pt-[140px] lg:pt-[245px]">
                            ...
                            <div className="flex flex-wrap px-3 pt-12 pb-12 md:pb-0 lg:pt-0">
                                ...
                                <div
                                    ...
                                    <div className="align-start flex">
                                        ...
                                        <div className="mr-6 grow">
                                            <p className="mb-2 font-bold dark:text-white">مطبوعات</p>
                                            <p className="text-neutral-500 dark:text-neutral-200">
                                                press@example.com
                                            </p>
                                            <p className="text-neutral-500 dark:text-neutral-200">
                                ...
                                <div className="w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
                                    <div className="align-start flex">
                                        ...
                                        <div className="mr-6 grow">
                                            <p className="mb-2 font-bold dark:text-white">گزارش باگ!</p>
                                            <p className="text-neutral-500 dark:text-neutral-200">
                                                bugs@example.com
                                            </p>
                                            <p className="text-neutral-500 dark:text-neutral-200">
